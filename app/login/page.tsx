...
//       if (!response.ok) {
//         setAttempts((prev) => prev + 1);
//         console.log("Failed login attempt:", { attempts: attempts + 1, error: data.error });
//         if (attempts >= 4) {
//           setIsLocked(true);
//           setTimeout(() => {
//             setIsLocked(false);
...
//       }
//       setAttempts(0);
//       console.log("Redirecting:", data.requiresMFA ? "to MFA" : "to dashboard");
//       if (data.requiresMFA) {
...
//   //     setAttempts(0);
//   //     if (data.requiresMFA) {
//   //       console.log("Redirecting to MFA with token:", data.tempToken);
//   //       router.push(`/auth/mfa?token=${data.tempToken}`);
//   //     } else {
