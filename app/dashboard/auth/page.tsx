...
// Define Auth interface to match Prisma schema
...
export default function AuthPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const authData: Partial<Auth> = {
      ...
      employeeId: (formData.get("employeeId") as string) || null, // Handle empty string as null
    }
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    name="roleId"
                    required
                    value={editingAuth?.roleId ?? ""}
                    onValueChange={(value) => {
                      const select = document.querySelector('select[name="roleId"]') as HTMLSelectElement
...
//       auth.Role?.name?.toLowerCase().includes(searchTerm.toLowerCase()),
//   )
